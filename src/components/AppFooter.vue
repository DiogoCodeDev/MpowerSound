...
<template>
	<footer
		...
		<div class="w-80 md:w-96 flex flex-col justify-center lg:items-center lg:w-1/3 mb-10 lg:mb-0">
			<div>
		...
		<div class="w-80 md:w-96 flex flex-col justify-center lg:items-center lg:justify-start lg:w-1/3">
			<div>
